...
public class CliFrontend {
    ...
    protected void run(String[] args) throws Exception {
        ...
        // 获取active的命令行 顺序依次是 Generic yarn Default
        final CustomCommandLine activeCommandLine =
                validateAndGetActiveCommandLine(checkNotNull(commandLine));
        ...
        /** 获取有效配置 HA的id JObmanager TAskManager的内存 每个TM的slot数 .... **/
        final Configuration effectiveConfiguration =
    ...
    public static void main(final String[] args) {
        ...
        // 依次添加 Generic Yarn和Default三种命令行，后面根据isActive按顺序选择
    ...
    /**
     * 依次添加 Generic Yarn和Default三种命令行，后面根据isActive按顺序选择
     * @param configuration flink配置文件配置
     * @param configurationDirectory flink配置文件路径
     * @return
     */
