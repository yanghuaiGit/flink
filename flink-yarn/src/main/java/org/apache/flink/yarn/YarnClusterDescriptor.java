...
public class YarnClusterDescriptor implements ClusterDescriptor<ApplicationId> {
    ...
    private ApplicationReport startAppMaster(
        ...
        /** yarn文件上传  用户jar包 flink的依赖  flink的配置文件**/
        ...
        // The files need to be shipped and added to classpath. shipFiles 需要上传的文件
        ...
        // only for per job mode  perjob需要上传的一些东西
        if (jobGraph != null) {
        ...
        // Setup jar for ApplicationMaster flink的jar包上传 lib目录下的dist.jar包等
        ...
        // Upload the flink configuration 上传flink的配置文件
